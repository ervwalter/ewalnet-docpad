...
module.exports = function(BasePlugin) {
  var PagedPlugin, TaskGroup, path, _ref;
    ...
    PagedPlugin.prototype.renderBefore = function(opts, next) {
      ...
      sourcePageDocuments.forEach(function(document) {
        return tasks.addGroup(function(addGroup, addTask) {
          var basename, extension, filePath, filename, lastDoc, meta, numberOfPages, outBasename, outExtension, outFilename, pagePathPrefix, pageSize, pagedCollection, pagedCollectionName, pages, relativePath, url, _i, _results;
          meta = document.getMeta();
          numberOfPages = meta.get('pageCount') || 1;
          pageSize = meta.get('pageSize') || 1;
          lastDoc = pageSize * numberOfPages;
          pagePathPrefix = meta.get('pagePathPrefix') || '';
          ...
          if (numberOfPages > 1) {
            return (function() {
              ...
              return addTask(function(complete) {
                var pageDocument, pageFilename, pageOutFilename, pagePath, pageRelativePath;
                if (config.cleanurl) {
                  ...
                  if (pagePathPrefix.length > 0) {
                    pagePath = path.join(pagePathPrefix, pagePath);
                  }
                  if (basename === 'index') {
